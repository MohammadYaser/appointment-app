...
const AddEngineerForm = () => {
    ...
    const [consultancy_fee, setConsultancyFee] = useState('');
    ...
    const handleSubmit = async (event) => {
        ...
        // Form validation
        if (!name || !photo || !consultancy_fee || !speciality || !about) {
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            ...
                            <input
                                ...
                                value={consultancy_fee} // Changed from consultationFee to consultancyFee
                                onChange={(e) => setConsultancyFee(e.target.value)} // Changed from setConsultationFee to setConsultancyFee
                                required
                            />
                        </div>
                        <div className="mb-3">
                        ...
                        {successMessage && <div className="alert alert-success">{successMessage}</div>}                        <button type="submit" className="btn btn-primary">Add Engineer</button>
                    </form>
                </div>
            </div>
        </div>
